...
class Kernel extends Application implements KernelInterface
{
    ...
    public function __construct($env = 'prod')
    {
        ...
        $this->setConfigDir($this->rootDir.'/app/config');
        $this->setCacheDir($this->rootDir.'/var/cache');
        $this->setLogsDir($this->rootDir.'/var/logs');
        $this->setViewDir($this->rootDir.'/src/Resources/views');
